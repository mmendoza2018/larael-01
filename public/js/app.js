...
if (document.getElementById("dropzone")) {
  var myDropzone = new dropzone__WEBPACK_IMPORTED_MODULE_0__["default"]("#dropzone", {
    ...
    dictDefaultMessage: "Arrastra tus imágenes aquí o haz clic para seleccionar",
    // Mensaje por defecto
    addRemoveLinks: true
  });
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          formData2 = new FormData(event.target); // Iteramos sobre los campos del nuevo FormData y los agregamos a formData1
          _iterator = _createForOfIteratorHelper(formData1.entries());
          try {
